...
- 淘汰（Trump）
    ...
    - 对于高清重编码（HD）
        - 在 BDRip 发布后，所有在来源质量上不如 BDRip 的版本（HDTV、WEB-DL 等）都会被立刻删除（最终判断依据始终为来源的实际质量和观看体验，例如，如果 Blu-ray Source 较 WEB Source 质量更差，则来自 WEB Source 的优质重编码将被优先考虑保留），新版本不会获得随机促销以外的其他促销
