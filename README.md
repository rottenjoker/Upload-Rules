...
- 淘汰（Trump）
    - 对于高清重编码（HD）
        - 在 BDRip 发布后，所有在来源质量上不如 BDRip 的版本（HDTV、WEB-DL 等）都会被立刻删除，新版本不会获得 Trump 给予的促销 ***// 无 trump 促销***
        - 相同分辨率下，新发布的 BDRip 必须拥有和已发布版本相近的，或更好的视频质量，否则会被立刻删除 ***// 调整***
            - Trump 达成后，旧版本将被删除，新版本获得 24 小时“免费” ***// 针对常规洗版***
            - 允许一段时间内多个质量相近的版本共存，管理组会选取一个相对最优的版本并给予 72 小时“置顶”和“免费”，以及“[推荐]”标签 ***// 针对新出 BD 的片***
            - ~~管理组选取之后，如果有更好的版本发布，那么会重新进行选取的工作~~ ***// 直接走“常规洗版”一条***
