...
- 单独的样片（样片请和正片一起上传）
- 未经过候选发布的电影合集
- 视频码率偏低的资源，通过[查看 MediaInfo]() 可以得知视频码率
    - 通常情况下 720p Rip 和 1080p Rip 至少需要 5000 kb/s 和 10000 kb/s 左右的码率来取得较优的观看体验，我们不建议发布码率明显偏低的资源
- 经过二次压制的资源，任何重编码资源都应采用无损来源
- 重复（Dupe）的资源（详见此处）
- 一些特定资源
    - NowYS、CMCT 和 CkreleaSe 出的新片“DVDRip”
    - YYeTs 制作的 HR-HDTV 资源
    - 韩国 TC、Pretail
    - 劣质 WEB-DL 压制小组（SmY、SeeHD、Mp4Ba、KORSUB）的作品
...
- 请务必在简介中附上影片的 MediaInfo（获取方法），这能让其他用户非常直观地了解影片的视频、音频、字幕等轨道的信息
- ...
...
## To dicuss
- 禁止发布的小组名单更新？添加部分 AHD/PTP 等站被禁的组？
- 他站禁转资源相关规则
