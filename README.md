...
- 受限于日益变化的标准和管理组的能力，要在下文囊括所有的相关条目既不科学也不现实，因此对于规则在将来可能出现的疏漏和描述模糊的部分，管理组保留最终决定权，同时也会不断更新现行规则
...
- 标题
- 外部链接
    - 请务必填上正确的 IMDb 链接，这不仅有助于搜索某部影片和查询该影片的其他版本，还有助于我们对资源的管理
    - 
- NFO 文件
- 简介
...
- 淘汰（Trump）
    - 对于标清重编码（SD）
        - 原则上不进行 Trump，除非原先版本存在明显的问题或劣于新发布版本
    - 对于高清重编码（HD）
        - 对于站内尚未发布 BDRip 的影片
