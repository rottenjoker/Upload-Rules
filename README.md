...
- 淘汰（Trump）
    - 视频质量，即正常回放中的实际观看体验，是 Trump 机制的首要考虑因素，
    - 对于高清重编码（HD）
        - 在 BDRip 发布后，所有在来源质量上不如 BDRip 的版本（HDTV、WEB-DL 等）都会被立刻删除，新版本不会获得 Trump 给予的促销
        - 新发布的 BDRip 必须比已发布的 BDRip 拥有更好的视频质量，否则会被立刻删除，Trump 达成后新版本获得 24 小时“免费”
        - 允许一段时间内多个版本 BDRip 共存，管理组会选取一个（或最多不超过两个）相对较优版本并给予 24 小时“免费”
