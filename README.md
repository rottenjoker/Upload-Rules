...
- 淘汰（Trump）
    ...
    - 对于高清重编码（HD）
        - 在 BDRip 发布后，所有在来源质量上不如 BDRip 的版本（HDTV、WEB-DL 等）都会被立刻删除，新版本不会获得 Trump 给予的促销
        - 新发布的 BDRip 必须比已发布的 BDRip 拥有更好的视频质量，否则会被立刻删除
        - 允许一段时间内多个版本 BDRip 共存，管理组会选取一个（或最多不超过两个）相对较优版本并给予 24 小时“免费” ***// 原帖说的最终版本给置顶和标签这条好像没有执行过？***
